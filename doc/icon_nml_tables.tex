...
%
%MARK_01_START
%We inform the user about the removal of two optional diagnostics right here, on site.
%Doing so for six months, starting June 2023, should be sufficient.
%Afterwards everything between MARK_01_START and MARK_01_END (including themselves) should be removed.
  \ifthenelse{\year=2023 \AND \(\month>5 \AND \month<13\)}
  ...
  {
    \ifthenelse{\year=2024 \AND \(\month>0 \AND \month<4\)}
