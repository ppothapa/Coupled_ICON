...
\begin{changeitem}{nonhydrostatic\_nml}{2023-05-22}{icon-nwp:master xxx}
  \begin{itemize}
...
\begin{changeitem}{Optional output diagnostics, see table~\ref{tab:optionaldiagnostics} on page~\pageref{tab:optionaldiagnostics}}{2023-06-13}{icon-nwp:master xxx}
  \begin{itemize}
