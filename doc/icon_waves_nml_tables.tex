...
iforc\_waves& I  & 1        &     & 1: test case & \tabularnewline
 ...
 forc\_file\_prefix &C&     &     & common prefix of forcing files & \tabularnewline
                    ...
                    & &     &     & Data for all time steps in the current simulation should be prepared in a single file. Variables should be named \texttt{u\_10m}, \texttt{v\_10m}, \texttt{fr\_seaice}, ??? & \tabularnewline
\end{longtab}
