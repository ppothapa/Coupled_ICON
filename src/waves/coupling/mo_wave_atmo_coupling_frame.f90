!>
!! @brief Initialisation of wave-atmosphere coupling
!!
...
MODULE mo_wave_atmo_coupling_frame
  ...
  CHARACTER(len=*), PARAMETER :: str_module = 'mo_wave_atmo_coupling_frame'
...
CONTAINS
  ...
  !>
  !! SUBROUTINE construct_wave_atmo_coupling -- the initialisation for the coupling
  ...
  !!
  SUBROUTINE construct_wave_atmo_coupling (p_patch)

    TYPE(t_patch), TARGET, INTENT(IN) :: p_patch(:)

    CHARACTER(len=*), PARAMETER :: routine = str_module//':construct_wave_atmo_coupling'
...
END MODULE mo_wave_atmo_coupling_frame
