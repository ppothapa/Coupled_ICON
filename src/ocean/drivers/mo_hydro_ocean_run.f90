...
!          sea_ice,0)
      ...
      !------------------------------------------------------------------------
        ...
        !$ACC   COPY(patch_2d%cells%owned, patch_2d%cells%owned%vertical_levels, patch_2d%cells%area) &
        ...
        !$ACC   COPY(sea_ice%hi, sea_ice%conc, sea_ice%hs, sea_ice%zunderice, sea_ice%draftave_old) IF(lacc)
