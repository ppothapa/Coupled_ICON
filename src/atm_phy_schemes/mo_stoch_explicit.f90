...
!!
!! @author Mirjana Sakradzija, MPI-M
!! @author Axel Seifert, DWD
!! @author Maike Ahlgrimm, DWD
!!
!! @par Revision History
!!      First implementation by Mirjana Sakradzija, MPI-M (Dec, 2015)
!!      Linked lists replaced by finite arrays by Mirjana Sakradzija, MPI-M (Apr, 2018)
!!      Extended to include additional diagnostics, derived updraft fraction
!!        and detrainment profile by M Ahlgrimm (Sep 2021)
!!
!!-----------------------------------------------------------------------------
!
