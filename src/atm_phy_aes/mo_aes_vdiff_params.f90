...
!! Renamed routine to mo_aes_vdiff_params, M. Esch, MPI-M (2022-03)
!!
...
MODULE mo_aes_vdiff_params
  ...
  REAL(wp),PARAMETER :: eps_shear = 1.e-5_wp   !< 
  REAL(wp),PARAMETER :: eps_corio = 5.e-5_wp   !< 
...
END MODULE mo_aes_vdiff_params
