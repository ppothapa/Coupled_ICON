...
CONTAINS
  ...
  SUBROUTINE copy_i0d_to_i1d(j1s,j1e, i0d_in,i1d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e, i0d_in)
  ...
  SUBROUTINE copy_i0d_to_i2d(j1s,j1e, j2s,j2e, i0d_in,i2d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e, j2s, j2e, i0d_in)
  ...
  SUBROUTINE copy_r0d_to_r1d(j1s,j1e, r0d_in,r1d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e, r0d_in)
    !$ACC LOOP GANG VECTOR
    DO j1 = j1s,j1e
       r1d_out(j1) = r0d_in
    END DO
  ...
  SUBROUTINE copy_r0d_to_r2d(j1s,j1e, j2s,j2e, r0d_in,r2d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e, j2s, j2e, r0d_in)
    !$ACC LOOP GANG VECTOR COLLAPSE(2)
    DO j2 = j2s,j2e
       DO j1 = j1s,j1e
  ...
  SUBROUTINE copy_r1d_to_r1d(j1s,j1e, r1d_in,r1d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e)
    !$ACC LOOP GANG VECTOR
    DO j1 = j1s,j1e
  ...
  SUBROUTINE copy_r2d_to_r2d(j1s,j1e, j2s,j2e, r2d_in,r2d_out)
    ...
    !$ACC PARALLEL DEFAULT(NONE) FIRSTPRIVATE(j1s, j1e, j2s, j2e)
    !$ACC LOOP GANG VECTOR COLLAPSE(2)
    DO j2 = j2s,j2e
       DO j1 = j1s,j1e
