...
MODULE mo_interface_cloud_mig_1
  ...
  IMPLICIT NONE
  PRIVATE
  PUBLIC  :: interface_cloud_mig_1

CONTAINS

  SUBROUTINE interface_cloud_mig_1(jg,jb,jcs,jce        ,&
       &                           nproma,nlev,ntracer  ,& 
    ...
    IF ( is_in_sd_ed_interval ) THEN
       ...
       IF ( is_active ) THEN
          ...
          CALL cloud_mig( jg                                  ,& !< in : grid index
               ...
               &          field% cpair     (:,jks:jke,jb)     ,& !< in : specific heat of air
...
!!$            ...
  ...
  END SUBROUTINE interface_cloud_mig_1

END MODULE mo_interface_cloud_mig_1
